class DashboardController {
    ...
    async checkReadOnlyMode() {
        try {
            ...
            if (this.readOnlyMode) {
                ...
                // تعطيل أزرار الإضافة والتعديل في كل الصفحات
    ...
    async updateChart() {
        try {
            // الحصول على بيانات الإنتاج لآخر 7 أيام
            const days = 7;
            const data = [];
